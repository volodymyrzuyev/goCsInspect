...
func ParseInspectLink(inspectLink string) (Parameters, error) {
	...
	if len(matches) != 5 {
		return Parameters{}, errors.ErrInvalidInspectLink
	}
	if matches[1] == "M" {
...
func (i Parameters) Validate() (err error) {
	err = nil
...
func (i Parameters) GenerateGcRequestProto() (*csProto.CMsgGCCStrike15V2_Client2GCEconPreviewDataBlockRequest, error) {
