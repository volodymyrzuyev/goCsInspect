...
func ParseInspectLink(inspectLink string) (InspectParameters, error) {
	...
	if len(matches) != 5 {
		return InspectParameters{}, errors.ErrInvalidInspectLink
	}
	if matches[1] == "M" {
...
func (i InspectParameters) GenerateGcRequestProto() (*csProto.CMsgGCCStrike15V2_Client2GCEconPreviewDataBlockRequest, error) {
